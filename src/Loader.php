...
class Loader
{
     ...
     * @var  string
     */
    protected $type_class = 'Hongyukeji\PluginPackage\Package';
     ...
     *
     * @return  \Hongyukeji\PluginPackage\Loader  The current object
     ...
     *
     * @return  \Hongyukeji\PluginPackage\Package[]  All the packages or the packages in the directory
